...
- Use the name to truthfully refer to this project ("built on SovereignAI",
  "compatible with SovereignAI", "a fork of SovereignAI").
- Keep the name in unmodified redistributions of official releases.
- Use it in articles, reviews, benchmarks, tutorials, and academic work.

## Please don't

- Offer a hosted or commercial service under the SovereignAI name or a
  confusingly similar one ("SovereignAI Cloud", "sovereign-ai-hosting").
- Ship a modified fork under the SovereignAI name or mark — rename it, and
  say it's a fork; that's honored, not resented.
